...
namespace Assignment2Entity.Models
{
    public partial class PRN_Assignment2Context : DbContext
    {
        ...
        public virtual DbSet<TlCategory> Categories { get; set; } = null!;
        public virtual DbSet<TlCustomer> Customers { get; set; } = null!;
        public virtual DbSet<TlOrder> Orders { get; set; } = null!;
        public virtual DbSet<TlOrderDetail> OrderDetails { get; set; } = null!;
        public virtual DbSet<TlProduct> Products { get; set; } = null!;
        public virtual DbSet<TlSupplier> Suppliers { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=localhost\\SQLEXPRESS; Initial Catalog=PRN_Assignment2;Trusted_Connection=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TlCategory>(entity =>
            {
            ...
            modelBuilder.Entity<TlCustomer>(entity =>
            {
            ...
            modelBuilder.Entity<TlOrder>(entity =>
            {
            ...
            modelBuilder.Entity<TlOrderDetail>(entity =>
            {
            ...
            modelBuilder.Entity<TlProduct>(entity =>
            {
            ...
            modelBuilder.Entity<TlSupplier>(entity =>
            {
